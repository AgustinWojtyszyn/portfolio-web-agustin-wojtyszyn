  ...
  return (
    <div className="relative bg-neutral-900 px-4 pb-6 pt-12 sm:px-8 sm:pb-8 sm:pt-14">
      <div className="absolute inset-x-0 -top-4 flex justify-center sm:-top-6">
        <a
          className="ui-btn rounded-full border border-white/40 bg-neutral-100 p-1 text-slate-900 ring-white ring-offset-2 ring-offset-gray-700/80 focus:outline-none focus:ring-2 sm:p-2"
          href={`/#${SectionId.Hero}`}>
      ...
      <div className="flex flex-col items-center gap-y-6">
        ...
        <a
          ...
          <span>
            {uiText.footerCreditPrefix} <span className="text-white">React</span>
            <span className="italic text-yellow">Resume</span>
          </span>
        </a>
        <span className="text-sm text-neutral-700">
          © Copyright {currentYear} {uiText.footerCopyrightName}
        </span>
      </div>
    </div>
  );
